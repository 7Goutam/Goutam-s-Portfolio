        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <div
                key={project.id}
                className="group relative overflow-hidden rounded-xl bg-gray-800 border border-gray-700 shadow-lg transition-transform duration-300 hover:scale-[1.03] hover:shadow-cyan-500/30"
              >
                {/* Project Image */}
                <img
                  src={project.image}
                ...
                {/* Overlay */}
                <div className="absolute inset-0 bg-black bg-opacity-70 backdrop-blur-sm text-white flex flex-col justify-center items-center px-6 opacity-0 group-hover:opacity-100 transition duration-500 ease-in-out">
                  ...
                  <div className="flex gap-6 mt-10">
                    {project.demoLink && (
                      <a
                        ...
                        className="border border-white text-white text-sm px-4 py-1 rounded-full hover:bg-white hover:text-black transition"
                      >
                        Live Demo
                      </a>
                    )}
